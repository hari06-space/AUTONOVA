  ...
  return (
    <>
      {Object.keys(comment).length > 0 && (
        <Grid size={12}>
          <Card sx={{ bgcolor: 'grey.50', ...theme.applyStyles('dark', { bgcolor: 'dark.main' }), px: 2, pt: 2, pb: 1, mt: 1.25 }}>
            <Grid container spacing={1}>
                    ...
                    <ButtonBase sx={{ borderRadius: '12px' }} aria-label='"more options"'>
                      <Avatar
                        ...
                        sx={{
                          ...
                          ...theme.applyStyles('dark', { bgcolor: 'dark.main', color: 'dark.light' }),
                          zIndex: 1,
              ...
              <Grid size={12}>
                <Stack direction="row" sx={{ color: 'grey.800', ...theme.applyStyles('dark', { color: 'grey.700' }), gap: 2 }}>
                  <Button

export const AuditReportManual = {
  title: 'Audit Score & Findings Multi-View Report SOP & User Manual',
  introduction: 'The Audit Score Report (QM1260) provides comprehensive multi-dimensional analytical views of QMS audit observations, score averages, and finding breakdowns grouped by Department, Audit Type, or individual Observation details.',
  steps: [

        ...
        <Grid container spacing={gridSpacing}>
          <Grid size={12}>
            <CardMediaWrapper>
              ...
              />
              <CardMediaGrid
                src={colorScheme === ThemeMode.DARK ? imageDarkGrid : imageGrid}
                title="Slider5 image"
            ...
            <PageContentWrapper>
              <Grid container spacing={gridSpacing}>
                ...
                <Grid size={12}>
                  <Grid container spacing={gridSpacing}>
                    <Grid>
                      <Typography variant="h5" sx={{ display: 'flex', alignItems: 'center', color: 'secondary.main' }}>
                              ...
                              <ButtonBase component={Link} href="https://dribbble.com/codedthemes" target="_blank" aria-label="dribble">
                                <Avatar
                                  sx={{
                                    ...
                                    bgcolor: 'grey.100',
                                    color: 'grey.500',
                                    ...theme.applyStyles('dark', { bgcolor: theme.vars.palette.dark.main, color: 'grey.600' })
                                  }}
                                >
                                  <IconBrandDribbble />
                                </Avatar>
                        ...
                        <Grid size={12}>
                          <Grid container spacing={1} sx={{ alignItems: 'center', justifyContent: 'flex-end' }}>
                            ...
                            <Grid>
                              <CardMedia
                                component="img"
                                src={colorScheme === ThemeMode.DARK ? companyDarkLogo : companyLightLogo}
                                alt="Berry"
                                sx={{ display: 'initial' }}
                              />
                            </Grid>

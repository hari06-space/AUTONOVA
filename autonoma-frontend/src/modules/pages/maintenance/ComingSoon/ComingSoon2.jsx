...
const TimeBlock = styled('div')(({ theme }) => ({
  ...
  ...theme.applyStyles('dark', { background: theme.vars.palette.dark.main, color: theme.vars.palette.dark.light }),
  borderRadius: '12px',
  padding: '24px 0',
  textAlign: 'center',
  fontWeight: 700,
    ...
    <ComingSoonCard>
      <CardContent>
        <Grid container spacing={gridSpacing} sx={{ justifyContent: 'center' }}>
          ...
          <Grid size={12}>
            <CardMediaWrapper>
              <CardMedia component="img" image={colorScheme === ThemeMode.DARK ? imageDarkGrid : imageGrid} title="Slider5 image" />

...
const columns = [
  ...
  { id: 'typeName', label: 'Type Name', minWidth: 250 },
...
export default function MaterialTypeMaster() {
  ...
  const perms = usePagePermissions(PAGE_CODES.NPD_MATERIAL_TYPE);
  ...
  const handleCloseDialog = (refresh) => {
    setDialogOpen(false);
    if (refresh === true) fetchMaterialTypes();
  };
  ...
  return (
    <MainCard fullWidth
      ...
      secondary={
        <BOSTableToolbar
          onRefresh={fetchMaterialTypes}
          onNew={handleOpenAdd}
          newTooltip={shortcutTooltip('Create New Material Type', 'Ctrl + N')}
          hasWritePermission={perms.write}
          exportData={filteredRows}
          exportFilename="Material_Type_Master"
    ...
    >
      ...
      <AddMaterialTypeDialog open={dialogOpen} handleClose={handleCloseDialog} initialData={selectedRow} readOnly={isReadOnly} />

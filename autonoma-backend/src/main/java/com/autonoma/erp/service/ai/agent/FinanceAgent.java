...
@Component
public class FinanceAgent extends BaseAiAgent {

    @Override
    public boolean canHandle(String intent, String module) {
        return "FINANCE".equalsIgnoreCase(module) || "ACCOUNTING".equalsIgnoreCase(module);
    }
    ...
    protected Map<String, Object> handleIntent(String userId, String tenantId, String sessionId, String question, String intent, String module, String languageCode) {
        ...
        String systemPrompt = buildSystemPrompt(userId, module, intent, languageCode, "Finance Agent");
        ...
        if ("QUERY".equals(intent) || "REPORT".equals(intent)) {
            ...
            if (!queryResult.success()) {
                ...
                return buildResponse(errorMsg != null ? errorMsg : "Error processing finance data", "TEXT", languageCode, intent, module, null, false, false);

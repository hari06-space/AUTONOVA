...
public class OcrConfig {
    ...
    @JoinColumn(name = "COMPANY_CREDENTIAL_ID", nullable = false)
    @JsonIgnore
    @ToString.Exclude
    private CompanyCredential companyCredential;

    @Column(name = "OCR_TENANT_ID", columnDefinition = "NVARCHAR(100)")
    private String ocrTenantId;

    @Column(name = "OCR_CLIENT_ID", columnDefinition = "NVARCHAR(100)")
    private String ocrClientId;

    @Column(name = "OCR_CLIENT_SECRET", columnDefinition = "NVARCHAR(255)")
    @Convert(converter = com.autonoma.erp.security.OcrConfigSecretConverter.class)
    private String ocrClientSecret;

    @Column(name = "OCR_SHARED_MAILBOX", columnDefinition = "NVARCHAR(100)")
    private String ocrSharedMailbox;

    @Column(name = "OCR_PROCESSED_FOLDER", columnDefinition = "NVARCHAR(100)")

...
@Entity
@Table(name = "CUSTOMER_SATISFACTION_RESPONSE")
@Data
@EqualsAndHashCode(callSuper = true)
@NoArgsConstructor
@AllArgsConstructor
public class CustomerSatisfactionResponse extends BaseAuditEntity {
    ...
    private CustomerSatisfactionMapping mapping;
    ...
    public CustomerSatisfactionMapping getMapping() { return mapping; }
    public void setMapping(CustomerSatisfactionMapping mapping) { this.mapping = mapping; }

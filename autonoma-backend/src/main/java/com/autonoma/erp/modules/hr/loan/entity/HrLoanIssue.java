...
@Entity
@Table(name = "HR_LOAN_ISSUE")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class HrLoanIssue {
    @Id
    ...
    @Temporal(TemporalType.TIMESTAMP)
    private Date shortCloseDate;

    @Column(name = "SHORT_CLOSE_REMARKS", length = 500)
    ...
    public Date getShortCloseDate() { return shortCloseDate; }
    public void setShortCloseDate(Date shortCloseDate) { this.shortCloseDate = shortCloseDate; }

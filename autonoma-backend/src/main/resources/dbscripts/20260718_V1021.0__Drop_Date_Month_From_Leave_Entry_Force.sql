-- V1021.0: Force drop DATE and MONTH columns from HR_LEAVE_ENTRY to fix insertion failures.
-- These columns are legacy/redundant and not mapped in the LeaveEntry entity.
